        ...
        if ($result) {
            ...
            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                ...
                while ($row1 = $product->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $total += $subtotal;
                    $html .= "<input type='checkbox' name='cartBox[]' value='$cartID'>";
                    $html .= $row1['name'] . " R$ " . $subtotal . "<hr>";
                }
            }
                    ...
                    <div class='dropdown'>
                        ...
                        <div id='account-menu' class='dropdown-content'>
                            <form action='./admin/admin_cart.php' method='GET'>
                                <input type='hidden' name='controlCart' id='controlCart' value='null'>
                                $html
                                <p>Total: R$ $total</p><br>
                                <hr>
                                <a href='#'>Comprar</a>
                                <hr>
                                <input type='submit' value='Descartar Selecionados'>
                            </form>
                        </div>
                    </div>
                </div>";
