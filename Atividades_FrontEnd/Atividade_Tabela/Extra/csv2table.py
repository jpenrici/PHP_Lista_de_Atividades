...
'''
    Simples conversão de CSV em HTML Table.

    python3 csv2table.py <arquivo_entrada.csv> <arquivo_saida.html>
''' 
...
if __name__ == "__main__":
   # main(sys.argv[1:])
   main(["tabela_preços_lista.csv", "table1.html"])
   main(["tabela_preços_dados.csv", "table2.html"])